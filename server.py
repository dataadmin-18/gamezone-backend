...
def start_mines():
    ...
    if active_game:
        ...
        # Do not create a second game. Return the
        # existing active game so a freshly reopened
        # Telegram Mini App can immediately resume it.
        return jsonify({
            "success": False,
            "active": True,
            "error":
            ...
            "active_game": {
                ...
                "grid_size": active_game["grid_size"],
                "mine_count": active_game["mine_count"],
                "bet": active_game["bet_amount"],
                "balance": current_balance,
                "revealed": revealed_tiles,
                "multiplier": active_game["multiplier"],
                "potential_win": active_game["potential_win"],
...
def play_keno():
    ...
    # --------------------------------------
    # READ SELECTED NUMBERS
    # --------------------------------------

    selected_numbers = data.get(
        "numbers",
        []
    )
    ...
    if len(selected_numbers) > 10:
        ...
        return jsonify({
            "success": False,
            "error":
                "You can select a maximum of 10 numbers."
        }), 400
    ...
    # ======================================
    #
    # Demo payout multipliers.
    #
    # The server calculates the payout.
    # The frontend never decides winnings.
    #
    # ======================================
