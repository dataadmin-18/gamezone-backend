...
def play_slots():
    ...
    if bet_amount > 1000:
        ...
        return jsonify({
            "success": False,
            "error": "Maximum demo bet is 1000 credits."
        }), 400
    ...
    if current_balance is None:
        ...
        return jsonify({
            "success": False,
            "error": "Balance could not be found."
        }), 500
    ...
    if new_balance is None:
        ...
        return jsonify({
            "success": False,
            "error": "Could not process demo bet."
        }), 500
    ...
    if win_amount > 0:
        ...
        if new_balance is None:
            ...
            return jsonify({
                "success": False,
                "error": "Could not process demo winnings."
            }), 500
