...
def finish_aviator_game(
    game_id, telegram_id, status,
    cashout_multiplier=0, win_amount=0
):
    ...
    """, (
        status, cashout_multiplier, win_amount,
        game_id, telegram_id
    ))
...
if __name__ == "__main__":
    ...
    print()
    print("Game Zone database initialized successfully.")
    print()
